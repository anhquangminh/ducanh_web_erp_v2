...
{
    public class Kho_DM_LoaiNhienLieuRepository : IKho_DM_LoaiNhienLieuRepository
    {
        private readonly IDbContextFactory<ApplicationDbContext> _context;
        public Kho_DM_LoaiNhienLieuRepository(IDbContextFactory<ApplicationDbContext> context)
        {
            _context = context;
        }
        public async Task<List<Kho_DM_LoaiNhienLieuModel>> GetAllByVM(Kho_DM_LoaiNhienLieuModel dataModel, string groupId)
        {
            try
            {
                using var context = _context.CreateDbContext();

                var baseQuery = context.Kho_DM_LoaiNhienLieus
                    .AsNoTracking()
                ...
                var data = baseData.Select(p1 => new Kho_DM_LoaiNhienLieuModel
                {
                    Id = p1.Id,
                    ...
                    LoaiNhienLieu = p1.LoaiNhienLieu,
                    GroupId = p1.GroupId,
        ...
        public async Task<List<Kho_DM_LoaiNhienLieuModel>> GetHistoryIsValidEdit(string id)
        {
            try
            {
                using var context = _context.CreateDbContext();
                var query = (from p1 in context.Kho_DM_LoaiNhienLieu_Logs
                             ...
                             orderby p1.CreateAt
                             select new Kho_DM_LoaiNhienLieuModel
                             {
                                 Id = p1.Id,
        ...
        public async Task<Kho_DM_LoaiNhienLieuModel> GetDetails(string id)
        {
            using var context = _context.CreateDbContext();
            var data = await (from p1 in context.Kho_DM_LoaiNhienLieus
        ...
        public async Task<List<Kho_DM_LoaiNhienLieuModel>> GetHistory(string id)
        {
            try
            {
                using var context = _context.CreateDbContext();
                var data = await (from p1 in context.Kho_DM_LoaiNhienLieu_Logs
                                  join Kho_DM_NhomNhienLieus1 in context.Kho_DM_NhomNhienLieus on p1.Id_NhomNhienLieu equals Kho_DM_NhomNhienLieus1.Id into Kho_DM_NhomNhienLieus11
                                  from Kho_DM_NhomNhienLieus1 in Kho_DM_NhomNhienLieus11.DefaultIfEmpty()
                                  join createBy in context.ApplicationUsers on p1.CreateBy equals createBy.Id
                                  join a in context.ApplicationUsers on p1.ApprovalUserId equals a.Id into a1
        ...
        public async Task<List<Kho_DM_LoaiNhienLieu>> GetAll(string groupId)
        {
            try
            {
                using var context = _context.CreateDbContext();
                var entity = await context.Kho_DM_LoaiNhienLieus.Where(p => p.IsActive != 100).OrderByDescending(p => p.CreateAt).ToListAsync();
                return entity;
            }
            catch (Exception ex)
            {
        ...
        public async Task<Kho_DM_LoaiNhienLieu> GetById(string id)
        {
            using var context = _context.CreateDbContext();
            var entity = await context.Kho_DM_LoaiNhienLieus.Where(x => x.Id.Equals(id) && x.IsActive != 100).FirstOrDefaultAsync();
            if (entity == null)
            {
        ...
        public async Task Insert(Kho_DM_LoaiNhienLieu entity, string userId)
        {
            try
            {
                using var context = _context.CreateDbContext();
                ...
                context.Kho_DM_LoaiNhienLieus.Add(entity);
                var addLog = new Kho_DM_LoaiNhienLieu_Log()
                {
                    Id_NhomNhienLieu = entity.Id_NhomNhienLieu,
                    LoaiNhienLieu = entity.LoaiNhienLieu,
                ...
                context.Kho_DM_LoaiNhienLieu_Logs.Add(addLog);
        ...
        public async Task Update(Kho_DM_LoaiNhienLieu data, string userId)
        {
            using var context = _context.CreateDbContext();
            ...
            context.Kho_DM_LoaiNhienLieus.Update(data);
            if (data.IsActive == 3)
            {
                var updateLog = await (from p in context.Kho_DM_LoaiNhienLieu_Logs
                                       where p.IdChung == entity.Id && p.IsValid == true
                                       select p).ToListAsync();
                updateLog.ForEach(p => p.IsValid = false);
                context.Kho_DM_LoaiNhienLieu_Logs.UpdateRange(updateLog);
            }
            ...
            else if (entity.IsActive != 3)
            {
                ...
                if (updateLog != null)
                {
                    ...
                    context.Kho_DM_LoaiNhienLieu_Logs.Update(updateLog);
                }
            }
            var addLog = new Kho_DM_LoaiNhienLieu_Log
            {
                Id_NhomNhienLieu = data.Id_NhomNhienLieu,
                LoaiNhienLieu = data.LoaiNhienLieu,
        ...
        public async Task UpdateMulti(Kho_DM_LoaiNhienLieu[] Kho_DM_LoaiNhienLieus)
        {
            using var context = _context.CreateDbContext();
            string[] ids = Kho_DM_LoaiNhienLieus.Select(x => x.Id).ToArray();
            var listEntities = await context.Kho_DM_LoaiNhienLieus.Where(x => ids.Contains(x.Id)).ToListAsync();
            foreach (var entity in listEntities)
            {
                context.Kho_DM_LoaiNhienLieus.Update(entity);
            }
            await context.SaveChangesAsync();
        }
        public async Task Delete(Kho_DM_LoaiNhienLieu data, string userId)
        {
            using var context = _context.CreateDbContext();
            var entity = await GetById(data.Id);
            if (entity == null)
            ...
            else
            {
                ...
                {
                    var logdata = (from p in context.Kho_DM_LoaiNhienLieu_Logs
                                   where p.IdChung == entity.Id && p.IsValid == true
                    ...
                    if (logdata != null)
                    {
                        ...
                        data.LoaiNhienLieu = logdata.LoaiNhienLieu;
                        ...
                        context.Kho_DM_LoaiNhienLieu_Logs.Update(logdata);
                    }
                    var logupdate = (from p in context.Kho_DM_LoaiNhienLieu_Logs
                                     where p.IdChung == entity.Id && p.IsValid == true
                                     select p).ToList();
                    if (logupdate != null)
                    {
                        logupdate.ForEach(p => p.IsValid = false);
                        context.Kho_DM_LoaiNhienLieu_Logs.UpdateRange(logupdate);
                    }
                    var addLog = new Kho_DM_LoaiNhienLieu_Log()
                    {
                        Id_NhomNhienLieu = data.Id_NhomNhienLieu,
        ...
        public async Task Approval(Kho_DM_LoaiNhienLieu data, string userId)
        {
            using var context = _context.CreateDbContext();
            var entity = await GetById(data.Id);
            if (entity == null)
        ...
        public async Task NoApproval(Kho_DM_LoaiNhienLieu data, string userId)
        {
            using var context = _context.CreateDbContext();
            var entity = await GetById(data.Id);
            ...
            else
            {
                ...
                else if (entity.IsActive == 1)
                {
                    ...
                    if (logdata != null)
                    {
                        ...
                        entity.LoaiNhienLieu = logdata.LoaiNhienLieu;
        ...
        public async Task DeleteById(string id, string userId)
        {
            ...
            context.Set<Kho_DM_LoaiNhienLieu>().Remove(entity);
            await context.SaveChangesAsync();
        }
        public async Task<bool> CheckStatus(string ids, string name)
        {
            using var context = _context.CreateDbContext();
            var model = await context.Kho_DM_LoaiNhienLieus.Where(p => p.Id == ids && p.IsActive != 100).FirstOrDefaultAsync();
            if (model == null)
            {
                throw new Exception($"Không tìm thấy dữ liệu đã chonj!");
            }
        ...
        public async Task<bool> CheckSave(Kho_DM_LoaiNhienLieu input)
        {
            try
            {
                using var context = _context.CreateDbContext();
                var model = await (from p in context.Kho_DM_LoaiNhienLieu_Logs
                                   where p.GroupId == input.GroupId && p.IdChung != input.Id && p.IsValid == true && p.IsActive != 100
                            && p.Id_NhomNhienLieu == input.Id_NhomNhienLieu
                            && p.LoaiNhienLieu == input.LoaiNhienLieu
        ...
        public async Task<bool> CheckEdit(Kho_DM_LoaiNhienLieu input)
        {
            try
            {
                using var context = _context.CreateDbContext();
        ...
        public async Task<bool> CheckDelete(Kho_DM_LoaiNhienLieu input)
        {
            try
            {
                using var context = _context.CreateDbContext();
