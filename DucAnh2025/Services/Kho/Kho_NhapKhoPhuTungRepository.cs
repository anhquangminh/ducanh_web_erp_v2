...
{
    public class Kho_NhapKhoPhuTungRepository : IKho_NhapKhoPhuTungRepository
    {
        private readonly IDbContextFactory<ApplicationDbContext> _context;
        public Kho_NhapKhoPhuTungRepository(IDbContextFactory<ApplicationDbContext> context)
        {
            _context = context;
        }
        public async Task<List<Kho_NhapKhoPhuTungModel>> GetAllByVM(Kho_NhapKhoPhuTungModel dataModel, string groupId)
        {
            try
            {
                using var context = _context.CreateDbContext();

                var baseQuery = context.Kho_NhapKhoPhuTungs
                    .AsNoTracking()
                ...
                var Kho_HDMuaNhienLieusDict = await context.Kho_HDMuaNhienLieus.AsNoTracking().ToDictionaryAsync(x => x.Id);
                ...
                var data = baseData.Select(p1 => new Kho_NhapKhoPhuTungModel
                {
                    Id = p1.Id,
                    Id_Tram = ChiNhanhsDict.TryGetValue(p1.Id_Tram, out var tmpChiNhanhs) ? tmpChiNhanhs.TenChiNhanh : "",
                    DungChoThietBi = p1.DungChoThietBi,
                    NgayNhapKho = p1.NgayNhapKho,
                    SoPhieu = p1.SoPhieu,
                    SoHopDong = Kho_HDMuaNhienLieusDict.TryGetValue(p1.SoHopDong, out var tmpKho_HDMuaNhienLieus) ? tmpKho_HDMuaNhienLieus.SoHopDong : "",
                    ...
                    DVSauQD = p1.DVSauQD,
                    KLCoThueQD = p1.KLCoThueQD,
                    KLKhongThueQD = p1.KLKhongThueQD,
                    DonGiaCoThueQD = p1.DonGiaCoThueQD,
                    DonGiaKhongThueQD = p1.DonGiaKhongThueQD,
                    ThanhTienCoThueQD = p1.ThanhTienCoThueQD,
                    ThanhTienKhongThueQD = p1.ThanhTienKhongThueQD,
        ...
        public async Task<List<Kho_NhapKhoPhuTungModel>> GetHistoryIsValidEdit(string id)
        {
            try
            {
                using var context = _context.CreateDbContext();
                var query = (from p1 in context.Kho_NhapKhoPhuTung_Logs
                             ...
                             orderby p1.CreateAt
                             select new Kho_NhapKhoPhuTungModel
                             {
                                 Id = p1.Id,
        ...
        public async Task<Kho_NhapKhoPhuTungModel> GetDetails(string id)
        {
            using var context = _context.CreateDbContext();
            var data = await (from p1 in context.Kho_NhapKhoPhuTungs
        ...
        public async Task<List<Kho_NhapKhoPhuTungModel>> GetHistory(string id)
        {
            try
            {
                using var context = _context.CreateDbContext();
                var data = await (from p1 in context.Kho_NhapKhoPhuTung_Logs
                                  join ChiNhanhs1 in context.ChiNhanhs on p1.Id_Tram equals ChiNhanhs1.Id into ChiNhanhs11
                                  from ChiNhanhs1 in ChiNhanhs11.DefaultIfEmpty()
                                  join Kho_HDMuaNhienLieus1 in context.Kho_HDMuaNhienLieus on p1.SoHopDong equals Kho_HDMuaNhienLieus1.Id into Kho_HDMuaNhienLieus11
                                  from Kho_HDMuaNhienLieus1 in Kho_HDMuaNhienLieus11.DefaultIfEmpty()
        ...
        public async Task<List<Kho_NhapKhoPhuTung>> GetAll(string groupId)
        {
            try
            {
                using var context = _context.CreateDbContext();
                var entity = await context.Kho_NhapKhoPhuTungs.Where(p => p.IsActive != 100).OrderByDescending(p => p.CreateAt).ToListAsync();
                return entity;
            }
            catch (Exception ex)
            {
        ...
        public async Task<Kho_NhapKhoPhuTung> GetById(string id)
        {
            using var context = _context.CreateDbContext();
            var entity = await context.Kho_NhapKhoPhuTungs.Where(x => x.Id.Equals(id) && x.IsActive != 100).FirstOrDefaultAsync();
            if (entity == null)
            {
        ...
        public async Task Insert(Kho_NhapKhoPhuTung entity, string userId)
        {
            try
            {
                using var context = _context.CreateDbContext();
                ...
                context.Kho_NhapKhoPhuTungs.Add(entity);
                var addLog = new Kho_NhapKhoPhuTung_Log()
                {
                    Id_Tram = entity.Id_Tram,
                    DungChoThietBi = entity.DungChoThietBi,
                    ...
                    DVSauQD = entity.DVSauQD,
                    KLCoThueQD = entity.KLCoThueQD,
                    KLKhongThueQD = entity.KLKhongThueQD,
                    DonGiaCoThueQD = entity.DonGiaCoThueQD,
                    DonGiaKhongThueQD = entity.DonGiaKhongThueQD,
                    ThanhTienCoThueQD = entity.ThanhTienCoThueQD,
                    ThanhTienKhongThueQD = entity.ThanhTienKhongThueQD,
                ...
                context.Kho_NhapKhoPhuTung_Logs.Add(addLog);
        ...
        public async Task Update(Kho_NhapKhoPhuTung data, string userId)
        {
            using var context = _context.CreateDbContext();
            ...
            context.Kho_NhapKhoPhuTungs.Update(data);
            if (data.IsActive == 3)
            {
                var updateLog = await (from p in context.Kho_NhapKhoPhuTung_Logs
                                       where p.IdChung == entity.Id && p.IsValid == true
                                       select p).ToListAsync();
                updateLog.ForEach(p => p.IsValid = false);
                context.Kho_NhapKhoPhuTung_Logs.UpdateRange(updateLog);
            }
            ...
            else if (entity.IsActive != 3)
            {
                ...
                if (updateLog != null)
                {
                    ...
                    context.Kho_NhapKhoPhuTung_Logs.Update(updateLog);
                }
            }
            var addLog = new Kho_NhapKhoPhuTung_Log
            {
                Id_Tram = data.Id_Tram,
                DungChoThietBi = data.DungChoThietBi,
                ...
                DVSauQD = data.DVSauQD,
                KLCoThueQD = data.KLCoThueQD,
                KLKhongThueQD = data.KLKhongThueQD,
                DonGiaCoThueQD = data.DonGiaCoThueQD,
                DonGiaKhongThueQD = data.DonGiaKhongThueQD,
                ThanhTienCoThueQD = data.ThanhTienCoThueQD,
                ThanhTienKhongThueQD = data.ThanhTienKhongThueQD,
        ...
        public async Task UpdateMulti(Kho_NhapKhoPhuTung[] Kho_NhapKhoPhuTungs)
        {
            using var context = _context.CreateDbContext();
            string[] ids = Kho_NhapKhoPhuTungs.Select(x => x.Id).ToArray();
            var listEntities = await context.Kho_NhapKhoPhuTungs.Where(x => ids.Contains(x.Id)).ToListAsync();
            foreach (var entity in listEntities)
            {
                context.Kho_NhapKhoPhuTungs.Update(entity);
            }
            await context.SaveChangesAsync();
        }
        public async Task Delete(Kho_NhapKhoPhuTung data, string userId)
        {
            using var context = _context.CreateDbContext();
            var entity = await GetById(data.Id);
            if (entity == null)
            ...
            else
            {
                ...
                {
                    var logdata = (from p in context.Kho_NhapKhoPhuTung_Logs
                                   where p.IdChung == entity.Id && p.IsValid == true
                    ...
                    if (logdata != null)
                    {
                        ...
                        data.DungChoThietBi = logdata.DungChoThietBi;
                        ...
                        data.DVSauQD = logdata.DVSauQD;
                        data.KLCoThueQD = logdata.KLCoThueQD;
                        data.KLKhongThueQD = logdata.KLKhongThueQD;
                        data.DonGiaCoThueQD = logdata.DonGiaCoThueQD;
                        data.DonGiaKhongThueQD = logdata.DonGiaKhongThueQD;
                        data.ThanhTienCoThueQD = logdata.ThanhTienCoThueQD;
                        data.ThanhTienKhongThueQD = logdata.ThanhTienKhongThueQD;
                        ...
                        context.Kho_NhapKhoPhuTung_Logs.Update(logdata);
                    }
                    var logupdate = (from p in context.Kho_NhapKhoPhuTung_Logs
                                     where p.IdChung == entity.Id && p.IsValid == true
                                     select p).ToList();
                    if (logupdate != null)
                    {
                        logupdate.ForEach(p => p.IsValid = false);
                        context.Kho_NhapKhoPhuTung_Logs.UpdateRange(logupdate);
                    }
                    var addLog = new Kho_NhapKhoPhuTung_Log()
                    {
                        Id_Tram = data.Id_Tram,
        ...
        public async Task Approval(Kho_NhapKhoPhuTung data, string userId)
        {
            using var context = _context.CreateDbContext();
            var entity = await GetById(data.Id);
            if (entity == null)
        ...
        public async Task NoApproval(Kho_NhapKhoPhuTung data, string userId)
        {
            using var context = _context.CreateDbContext();
            var entity = await GetById(data.Id);
            ...
            else
            {
                ...
                else if (entity.IsActive == 1)
                {
                    ...
                    if (logdata != null)
                    {
                        ...
                        entity.DungChoThietBi = logdata.DungChoThietBi;
                        ...
                        entity.DVSauQD = logdata.DVSauQD;
                        entity.KLCoThueQD = logdata.KLCoThueQD;
                        entity.KLKhongThueQD = logdata.KLKhongThueQD;
                        entity.DonGiaCoThueQD = logdata.DonGiaCoThueQD;
                        entity.DonGiaKhongThueQD = logdata.DonGiaKhongThueQD;
                        entity.ThanhTienCoThueQD = logdata.ThanhTienCoThueQD;
                        entity.ThanhTienKhongThueQD = logdata.ThanhTienKhongThueQD;
        ...
        public async Task DeleteById(string id, string userId)
        {
            ...
            context.Set<Kho_NhapKhoPhuTung>().Remove(entity);
            await context.SaveChangesAsync();
        }
        public async Task<bool> CheckStatus(string ids, string name)
        {
            using var context = _context.CreateDbContext();
            var model = await context.Kho_NhapKhoPhuTungs.Where(p => p.Id == ids && p.IsActive != 100).FirstOrDefaultAsync();
            if (model == null)
            {
                throw new Exception($"Không tìm thấy dữ liệu đã chonj!");
            }
        ...
        public async Task<bool> CheckSave(Kho_NhapKhoPhuTung input)
        {
            try
            {
                using var context = _context.CreateDbContext();
                var model = await (from p in context.Kho_NhapKhoPhuTung_Logs
                                   where p.GroupId == input.GroupId && p.IdChung != input.Id && p.IsValid == true && p.IsActive != 100
                            && p.Id_Tram == input.Id_Tram
                            && p.DungChoThietBi == input.DungChoThietBi
                            ...
                            && p.DVSauQD == input.DVSauQD
                            && p.KLCoThueQD == input.KLCoThueQD
                            && p.KLKhongThueQD == input.KLKhongThueQD
                            && p.DonGiaCoThueQD == input.DonGiaCoThueQD
                            && p.DonGiaKhongThueQD == input.DonGiaKhongThueQD
                            && p.ThanhTienCoThueQD == input.ThanhTienCoThueQD
                            && p.ThanhTienKhongThueQD == input.ThanhTienKhongThueQD
        ...
        public async Task<bool> CheckEdit(Kho_NhapKhoPhuTung input)
        {
            try
            {
                using var context = _context.CreateDbContext();
        ...
        public async Task<bool> CheckDelete(Kho_NhapKhoPhuTung input)
        {
            try
            {
                using var context = _context.CreateDbContext();
