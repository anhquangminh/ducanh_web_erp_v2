...
{
    public class NhanSu_RequestRepository : INhanSu_RequestRepository
    {
        private readonly IDbContextFactory<ApplicationDbContext> _context;
        public NhanSu_RequestRepository(IDbContextFactory<ApplicationDbContext> context)
        {
            _context = context;
        }
        public async Task<List<NhanSu_RequestModel>> GetAllByVM(NhanSu_RequestModel dataModel, string groupId)
        {
            try
            {
                using var context = _context.CreateDbContext();

                var baseQuery = context.NhanSu_Requests
                    .AsNoTracking()
                ...
                if (!string.IsNullOrEmpty(dataModel?.RequestTypeId))
                {
                    baseQuery = baseQuery.Where(m => m.RequestTypeId == dataModel.RequestTypeId);
                }
                if (!string.IsNullOrEmpty(dataModel?.LeaveTypeId))
                {
                    baseQuery = baseQuery.Where(m => m.LeaveTypeId == dataModel.LeaveTypeId);
                }
                if (!string.IsNullOrEmpty(dataModel?.CurrentApproverId))
                {
                    baseQuery = baseQuery.Where(m => m.CurrentApproverId == dataModel.CurrentApproverId);
                }
                ...
                var NhanSu_DM_RequestTypesDict = await context.NhanSu_DM_RequestTypes.AsNoTracking().ToDictionaryAsync(x => x.Id);
                var NhanSu_DM_LeaveTypesDict = await context.NhanSu_DM_LeaveTypes.AsNoTracking().ToDictionaryAsync(x => x.Id);

                var data = baseData.Select(p1 => new NhanSu_RequestModel
                {
                    Id = p1.Id,
                    ...
                    RequestTypeId = NhanSu_DM_RequestTypesDict.TryGetValue(p1.RequestTypeId, out var tmpNhanSu_DM_RequestTypes) ? tmpNhanSu_DM_RequestTypes.RequestTypeName : "",
                    RequestDate = p1.RequestDate.HasValue ? (DateTime)p1.RequestDate : DateTime.MinValue,
                    StartDate = p1.StartDate.HasValue ? (DateTime)p1.StartDate : DateTime.MinValue,
                    EndDate = p1.EndDate.HasValue ? (DateTime)p1.EndDate : DateTime.MinValue,
                    TotalDuration = p1.TotalDuration,
                    LeaveTypeId = NhanSu_DM_LeaveTypesDict.TryGetValue(p1.LeaveTypeId, out var tmpNhanSu_DM_LeaveTypes) ? tmpNhanSu_DM_LeaveTypes.LeaveTypeName : "",
                    Reason = p1.Reason,
                    CurrentApproverId = NhanSu_EmployeeProfilesDict.TryGetValue(p1.CurrentApproverId, out var tmpNhanSu_EmployeeProfiles2) ? tmpNhanSu_EmployeeProfiles2.FullName : "",
                    GroupId = p1.GroupId,
        ...
        public async Task<List<NhanSu_RequestModel>> GetHistoryIsValidEdit(string id)
        {
            try
            {
                using var context = _context.CreateDbContext();
                var query = (from p1 in context.NhanSu_Request_Logs
                             join NhanSu_EmployeeProfiles1 in context.NhanSu_EmployeeProfiles on p1.EmployeeId equals NhanSu_EmployeeProfiles1.Id
                             join NhanSu_DM_RequestTypes1 in context.NhanSu_DM_RequestTypes on p1.RequestTypeId equals NhanSu_DM_RequestTypes1.Id
                             join NhanSu_DM_LeaveTypes1 in context.NhanSu_DM_LeaveTypes on p1.LeaveTypeId equals NhanSu_DM_LeaveTypes1.Id
                             join NhanSu_EmployeeProfiles2 in context.NhanSu_EmployeeProfiles on p1.CurrentApproverId equals NhanSu_EmployeeProfiles2.Id
                             ...
                             orderby p1.CreateAt
                             select new NhanSu_RequestModel
                             {
                                 Id = p1.Id,
                                 EmployeeId = p1.EmployeeId,
                                 MaNhanVien = NhanSu_EmployeeProfiles1.EmployeeId,
                                 FullName = NhanSu_EmployeeProfiles1.FullName,
                                 RequestTypeId = NhanSu_DM_RequestTypes1.RequestTypeName,
                                 RequestDate = p1.RequestDate ?? DateTime.MinValue,
                                 StartDate = p1.StartDate ?? DateTime.MinValue,
                                 EndDate = p1.EndDate ?? DateTime.MinValue,
                                 TotalDuration = p1.TotalDuration,
                                 LeaveTypeId = NhanSu_DM_LeaveTypes1.LeaveTypeName,
                                 Reason = p1.Reason,
                                 CurrentApproverId = NhanSu_EmployeeProfiles2.FullName,
                                 GroupId = p1.GroupId,
                                 Ordinarily = p1.Ordinarily,
        ...
        public async Task<NhanSu_RequestModel> GetDetails(string id)
        {
            using var context = _context.CreateDbContext();
            var data = await (from p1 in context.NhanSu_Requests
                              ...
                              join NhanSu_DM_RequestTypes1 in context.NhanSu_DM_RequestTypes on p1.RequestTypeId equals NhanSu_DM_RequestTypes1.Id into NhanSu_DM_RequestTypes11
                              from NhanSu_DM_RequestTypes1 in NhanSu_DM_RequestTypes11.DefaultIfEmpty()
                              join NhanSu_DM_LeaveTypes1 in context.NhanSu_DM_LeaveTypes on p1.LeaveTypeId equals NhanSu_DM_LeaveTypes1.Id into NhanSu_DM_LeaveTypes11
                              from NhanSu_DM_LeaveTypes1 in NhanSu_DM_LeaveTypes11.DefaultIfEmpty()
                              join NhanSu_EmployeeProfiles2 in context.NhanSu_EmployeeProfiles on p1.CurrentApproverId equals NhanSu_EmployeeProfiles2.Id into NhanSu_EmployeeProfiles21
                              ...
                              select new NhanSu_RequestModel
                              {
                                  ...
                                  FullName = NhanSu_EmployeeProfiles1.FullName,
                                  RequestTypeId = NhanSu_DM_RequestTypes1.RequestTypeName,
                                  RequestDate = (DateTime)p1.RequestDate,
                                  StartDate = (DateTime)p1.StartDate,
                                  EndDate = (DateTime)p1.EndDate,
                                  TotalDuration = p1.TotalDuration,
                                  LeaveTypeId = NhanSu_DM_LeaveTypes1.LeaveTypeName,
                                  Reason = p1.Reason,
                                  CurrentApproverId = NhanSu_EmployeeProfiles2.FullName,
        ...
        public async Task<List<NhanSu_RequestModel>> GetHistory(string id)
        {
            try
            {
                using var context = _context.CreateDbContext();
                var data = await (from p1 in context.NhanSu_Request_Logs
                                  join NhanSu_EmployeeProfiles1 in context.NhanSu_EmployeeProfiles on p1.EmployeeId equals NhanSu_EmployeeProfiles1.Id into NhanSu_EmployeeProfiles11
                                  from NhanSu_EmployeeProfiles1 in NhanSu_EmployeeProfiles11.DefaultIfEmpty()
                                  join NhanSu_DM_RequestTypes1 in context.NhanSu_DM_RequestTypes on p1.RequestTypeId equals NhanSu_DM_RequestTypes1.Id into NhanSu_DM_RequestTypes11
                                  from NhanSu_DM_RequestTypes1 in NhanSu_DM_RequestTypes11.DefaultIfEmpty()
        ...
        public async Task<List<NhanSu_Request>> GetAll(string groupId)
        {
            try
            {
                using var context = _context.CreateDbContext();
                var entity = await context.NhanSu_Requests.Where(p => p.IsActive != 100).OrderByDescending(p => p.CreateAt).ToListAsync();
                return entity;
            }
            catch (Exception ex)
            {
        ...
        public async Task<NhanSu_Request> GetById(string id)
        {
            using var context = _context.CreateDbContext();
            var entity = await context.NhanSu_Requests.Where(x => x.Id.Equals(id) && x.IsActive != 100).FirstOrDefaultAsync();
            if (entity == null)
            {
        ...
        public async Task Insert(NhanSu_Request entity, string userId)
        {
            try
            {
                using var context = _context.CreateDbContext();
                ...
                context.NhanSu_Requests.Add(entity);
                var addLog = new NhanSu_Request_Log()
                {
                    ...
                    CurrentApproverId = entity.CurrentApproverId,
                ...
                context.NhanSu_Request_Logs.Add(addLog);
        ...
        public async Task Update(NhanSu_Request data, string userId)
        {
            using var context = _context.CreateDbContext();
            ...
            context.NhanSu_Requests.Update(data);
            if (data.IsActive == 3)
            {
                var updateLog = await (from p in context.NhanSu_Request_Logs
                                       where p.IdChung == entity.Id && p.IsValid == true
                                       select p).ToListAsync();
                updateLog.ForEach(p => p.IsValid = false);
                context.NhanSu_Request_Logs.UpdateRange(updateLog);
            }
            ...
            else if (entity.IsActive != 3)
            {
                ...
                if (updateLog != null)
                {
                    ...
                    context.NhanSu_Request_Logs.Update(updateLog);
                }
            }
            var addLog = new NhanSu_Request_Log
            {
        ...
        public async Task UpdateMulti(NhanSu_Request[] NhanSu_Requests)
        {
            using var context = _context.CreateDbContext();
            string[] ids = NhanSu_Requests.Select(x => x.Id).ToArray();
            var listEntities = await context.NhanSu_Requests.Where(x => ids.Contains(x.Id)).ToListAsync();
            foreach (var entity in listEntities)
            {
                context.NhanSu_Requests.Update(entity);
            }
            await context.SaveChangesAsync();
        }
        public async Task Delete(NhanSu_Request data, string userId)
        {
            using var context = _context.CreateDbContext();
            var entity = await GetById(data.Id);
            if (entity == null)
            ...
            else
            {
                ...
                {
                    var logdata = (from p in context.NhanSu_Request_Logs
                                   where p.IdChung == entity.Id && p.IsValid == true
                    ...
                    if (logdata != null)
                    {
                        ...
                        data.RequestTypeId = logdata.RequestTypeId;
                        data.RequestDate = logdata.RequestDate;
                        data.StartDate = logdata.StartDate;
                        data.EndDate = logdata.EndDate;
                        data.TotalDuration = logdata.TotalDuration;
                        data.LeaveTypeId = logdata.LeaveTypeId;
                        data.Reason = logdata.Reason;
                        data.CurrentApproverId = logdata.CurrentApproverId;
                        ...
                        context.NhanSu_Request_Logs.Update(logdata);
                    }
                    var logupdate = (from p in context.NhanSu_Request_Logs
                                     where p.IdChung == entity.Id && p.IsValid == true
                                     select p).ToList();
                    if (logupdate != null)
                    {
                        logupdate.ForEach(p => p.IsValid = false);
                        context.NhanSu_Request_Logs.UpdateRange(logupdate);
                    }
                    var addLog = new NhanSu_Request_Log()
                    {
                        EmployeeId = data.EmployeeId,
        ...
        public async Task Approval(NhanSu_Request data, string userId)
        {
            using var context = _context.CreateDbContext();
            var entity = await GetById(data.Id);
            if (entity == null)
        ...
        public async Task NoApproval(NhanSu_Request data, string userId)
        {
            using var context = _context.CreateDbContext();
            var entity = await GetById(data.Id);
            ...
            else
            {
                ...
                else if (entity.IsActive == 1)
                {
                    ...
                    if (logdata != null)
                    {
                        ...
                        entity.RequestTypeId = logdata.RequestTypeId;
                        entity.RequestDate = logdata.RequestDate;
                        entity.StartDate = logdata.StartDate;
                        entity.EndDate = logdata.EndDate;
                        entity.TotalDuration = logdata.TotalDuration;
                        entity.LeaveTypeId = logdata.LeaveTypeId;
                        entity.Reason = logdata.Reason;
                        entity.CurrentApproverId = logdata.CurrentApproverId;
        ...
        public async Task DeleteById(string id, string userId)
        {
            ...
            context.Set<NhanSu_Request>().Remove(entity);
            await context.SaveChangesAsync();
        }
        public async Task<bool> CheckStatus(string ids, string name)
        {
            using var context = _context.CreateDbContext();
            var model = await context.NhanSu_Requests.Where(p => p.Id == ids && p.IsActive != 100).FirstOrDefaultAsync();
            if (model == null)
            {
                throw new Exception($"Không tìm thấy dữ liệu đã chonj!");
            }
        ...
        public async Task<bool> CheckSave(NhanSu_Request input)
        {
            try
            {
                using var context = _context.CreateDbContext();
                var model = await (from p in context.NhanSu_Request_Logs
                                   where p.GroupId == input.GroupId && p.IdChung != input.Id && p.IsValid == true && p.IsActive != 100
                            && p.EmployeeId == input.EmployeeId
                            && p.RequestTypeId == input.RequestTypeId
                            && p.RequestDate == input.RequestDate
                            && p.StartDate == input.StartDate
                            && p.EndDate == input.EndDate
                            && p.TotalDuration == input.TotalDuration
                            && p.LeaveTypeId == input.LeaveTypeId
                            && p.Reason == input.Reason
                            && p.CurrentApproverId == input.CurrentApproverId
        ...
        public async Task<bool> CheckEdit(NhanSu_Request input)
        {
            try
            {
                using var context = _context.CreateDbContext();
        ...
        public async Task<bool> CheckDelete(NhanSu_Request input)
        {
            try
            {
                using var context = _context.CreateDbContext();
