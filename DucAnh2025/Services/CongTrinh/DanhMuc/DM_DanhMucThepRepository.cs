...
{
    public class DM_DanhMucThepRepository : IDM_DanhMucThepRepository
    {
        private readonly IDbContextFactory<ApplicationDbContext> _context;
        public DM_DanhMucThepRepository(IDbContextFactory<ApplicationDbContext> context)
        {
            _context = context;
        }
        public async Task<List<DM_DanhMucThepModel>> GetAllByVM(DM_DanhMucThepModel dataModel, string groupId)
        {
            using var context = _context.CreateDbContext();
            var query = from p1 in context.CT_DM_DanhMucTheps
                        where p1.GroupId == groupId && p1.IsActive != 100
                        select p1;
            if (!string.IsNullOrEmpty(dataModel.Id_TenLoaiThep))
            {
                query = query.Where(m => m.Id_TenLoaiThep == dataModel.Id_TenLoaiThep);
            }
            
            var data = await (from p1 in query
                              join tlt in context.CT_DM_TenLoaiTheps on p1.Id_TenLoaiThep equals tlt.Id
                              where p1.GroupId == groupId
                              orderby p1.CreateAt descending
                              select new DM_DanhMucThepModel
                              {
                                  Id = p1.Id,
                                  TenLoaiThep = tlt.TenDanhMuc,
                                  Id_TenLoaiThep = p1.Id,
                                  DuongKinh = p1.DuongKinh,
                                  DonVi = p1.DonVi,
        ...
        public async Task<List<DM_DanhMucThepModel>> GetHistoryIsValidEdit(string id)
        {
            try
            {
                using var context = _context.CreateDbContext();
                var data = await (from p1 in context.CT_DM_DanhMucThep_Logs
                                  join tlt in context.CT_DM_TenLoaiTheps on p1.Id_TenLoaiThep equals tlt.Id
        ...
        public async Task<DM_DanhMucThepModel> GetDetails(string id)
        {
            using var context = _context.CreateDbContext();
            var data = await (from p1 in context.CT_DM_DanhMucTheps
                              join tlt in context.CT_DM_TenLoaiTheps on p1.Id_TenLoaiThep equals tlt.Id
        ...
        public async Task<List<DM_DanhMucThepModel>> GetHistory(string id)
        {
            try
            {
                using var context = _context.CreateDbContext();
        ...
        public async Task<List<CT_DM_DanhMucThep>> GetAll(string groupId)
        {
            try
            {
                using var context = _context.CreateDbContext();
                var entity = await context.CT_DM_DanhMucTheps.Where(p => p.IsActive != 100).OrderByDescending(p => p.CreateAt).ToListAsync();
                return entity;
            }
            catch (Exception ex)
            {
        ...
        public async Task<CT_DM_DanhMucThep> GetById(string id)
        {
            using var context = _context.CreateDbContext();
            var entity = await context.CT_DM_DanhMucTheps.Where(x => x.Id.Equals(id) && x.IsActive != 100).FirstOrDefaultAsync();
            if (entity == null)
            {
        ...
        public async Task Insert(CT_DM_DanhMucThep entity, string userId)
        {
            try
            {
                using var context = _context.CreateDbContext();
                ...
                context.CT_DM_DanhMucTheps.Add(entity);
                var addLog = new CT_DM_DanhMucThep_Log()
                {
                    Id = entity.Id,
                ...
                context.CT_DM_DanhMucThep_Logs.Add(addLog);
        ...
        public async Task Update(CT_DM_DanhMucThep data, string userId)
        {
            using var context = _context.CreateDbContext();
            ...
            context.CT_DM_DanhMucTheps.Update(data);
            if (data.IsActive == 3)
            {
                var updateLog = await (from p in context.CT_DM_DanhMucThep_Logs
                                       where p.IdChung == entity.Id && p.IsValid == true
                                       select p).ToListAsync();
                updateLog.ForEach(p => p.IsValid = false);
                context.CT_DM_DanhMucThep_Logs.UpdateRange(updateLog);
            }
            ...
            else if (entity.IsActive != 3)
            {
                ...
                if (updateLog != null)
                {
                    ...
                    context.CT_DM_DanhMucThep_Logs.Update(updateLog);
                }
            }
            var addLog = new CT_DM_DanhMucThep_Log
            {
                Id = Guid.NewGuid().ToString(),
                Id_TenLoaiThep = data.Id_TenLoaiThep,
        ...
        public async Task UpdateMulti(CT_DM_DanhMucThep[] CT_DM_DanhMucTheps)
        {
            using var context = _context.CreateDbContext();
            string[] ids = CT_DM_DanhMucTheps.Select(x => x.Id).ToArray();
            var listEntities = await context.CT_DM_DanhMucTheps.Where(x => ids.Contains(x.Id)).ToListAsync();
            foreach (var entity in listEntities)
            {
                context.CT_DM_DanhMucTheps.Update(entity);
            }
            await context.SaveChangesAsync();
        }
        public async Task Delete(CT_DM_DanhMucThep data, string userId)
        {
            using var context = _context.CreateDbContext();
            var entity = await GetById(data.Id);
            if (entity == null)
            ...
            else
            {
                ...
                {
                    var logdata = (from p in context.CT_DM_DanhMucThep_Logs
                                   where p.IdChung == entity.Id && p.IsValid == true
                    ...
                    if (logdata != null)
                    {
                        ...
                        data.DuongKinh = logdata.DuongKinh;
                        ...
                        context.CT_DM_DanhMucThep_Logs.Update(logdata);
                    }

                    var logupdate = (from p in context.CT_DM_DanhMucThep_Logs
                                     where p.IdChung == entity.Id && p.IsValid == true
                                     select p).ToList();
                    if (logupdate != null)
                    {
                        logupdate.ForEach(p => p.IsValid = false);
                        context.CT_DM_DanhMucThep_Logs.UpdateRange(logupdate);
                    }
                    var addLog = new CT_DM_DanhMucThep_Log()
                    {
                        Id = Guid.NewGuid().ToString(),
        ...
        public async Task Approval(CT_DM_DanhMucThep data, string userId)
        {
            using var context = _context.CreateDbContext();
            var entity = await GetById(data.Id);
            if (entity == null)
        ...
        public async Task NoApproval(CT_DM_DanhMucThep data, string userId)
        {
            using var context = _context.CreateDbContext();
            var entity = await GetById(data.Id);
            ...
            else
            {
                ...
                else if (entity.IsActive == 1)
                {
                    ...
                    if (logdata != null)
                    {
                        entity.Id_TenLoaiThep = logdata.Id_TenLoaiThep;
                        entity.DuongKinh = logdata.DuongKinh;
                        entity.DonVi = logdata.DonVi;
                        entity.TrongLuong = logdata.TrongLuong;
        ...
        public async Task DeleteById(string id, string userId)
        {
            ...
            context.Set<CT_DM_DanhMucThep>().Remove(entity);
            await context.SaveChangesAsync();
        }
        public async Task<bool> CheckStatus(string ids, string name)
        {
            using var context = _context.CreateDbContext();
            var model = await context.CT_DM_DanhMucTheps.Where(p => p.Id == ids && p.IsActive != 100).FirstOrDefaultAsync();
            if (model == null)
            {
                throw new Exception($"Không tìm thấy dữ liệu đã chọn");
            }
        ...
        public async Task<bool> CheckSave(CT_DM_DanhMucThep input)
        {
            try
            {
                using var context = _context.CreateDbContext();
                var model = await (from p in context.CT_DM_DanhMucThep_Logs
                                   where p.GroupId == input.GroupId && p.IdChung != input.Id && p.IsValid == true && p.IsActive != 100
                                   && p.Id_TenLoaiThep == input.Id_TenLoaiThep && p.DuongKinh == input.DuongKinh 
                                   && p.DonVi == input.DonVi && p.TrongLuong == input.TrongLuong
                                   select p).CountAsync();
                if (model > 0)
                {
        ...
        public async Task<bool> CheckEdit(CT_DM_DanhMucThep input)
        {
            try
            {
                using var context = _context.CreateDbContext();
        ...
        public async Task<bool> CheckDelete(CT_DM_DanhMucThep input)
        {
            try
            {
                using var context = _context.CreateDbContext();
