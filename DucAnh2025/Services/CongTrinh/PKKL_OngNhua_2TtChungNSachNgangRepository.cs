...
{
    public class PKKL_OngNhua_2TtChungNSachNgangRepository : IPKKL_OngNhua_2TtChungNSachNgangRepository
    {
        private readonly IDbContextFactory<ApplicationDbContext> _context;
        public PKKL_OngNhua_2TtChungNSachNgangRepository(IDbContextFactory<ApplicationDbContext> context)
        {
            _context = context;
        }

        public async Task<List<PKKL_OngNhua_2TtChungNSachNgangModel>> GetAllByVM(PKKL_OngNhua_2TtChungNSachNgangModel dataModel, string groupId)
        {
            try
            {
                ...
                // Lấy dữ liệu gốc
                var baseData = await context.PKKL_OngNhua_2TtChungNSachNgangs
                    .AsNoTracking()
                ...
                // Map dữ liệu
                var data = baseData.Select(p1 => new PKKL_OngNhua_2TtChungNSachNgangModel
                {
                    Id = p1.Id,
        ...
        public async Task<List<PKKL_OngNhua_2TtChungNSachNgangModel>> GetHistoryIsValidEdit(string id)
        {
            try
            {
                using var context = _context.CreateDbContext();
                var data = await (from p1 in context.PKKL_OngNhua_2TtChungNSachNgang_Logs
                                  ...
                                  orderby p1.CreateAt
                                  select new PKKL_OngNhua_2TtChungNSachNgangModel
                                  {
                                      Id = p1.Id,
                                      Id_ChiNhanh= p1.Id_ChiNhanh,
        ...
        public async Task<PKKL_OngNhua_2TtChungNSachNgangModel> GetDetails(string id)
        {
            using var context = _context.CreateDbContext();
            var data = await (from p1 in context.PKKL_OngNhua_2TtChungNSachNgangs
                              join cn in context.ChiNhanhs on p1.Id_ChiNhanh equals cn.Id into cnJoin
                              from cn in cnJoin.DefaultIfEmpty()
        ...
        public async Task<List<PKKL_OngNhua_2TtChungNSachNgangModel>> GetHistory(string id)
        {
            try
            {
                using var context = _context.CreateDbContext();
        ...
        public async Task<List<PKKL_OngNhua_2TtChungNSachNgang>> GetAll(string groupId)
        {
            try
            {
                using var context = _context.CreateDbContext();
                var entity = await context.PKKL_OngNhua_2TtChungNSachNgangs.Where(p => p.IsActive != 100).ToListAsync();
                return entity;
            }
            catch (Exception ex)
            {
        ...
        public async Task<PKKL_OngNhua_2TtChungNSachNgang> GetById(string id)
        {
            using var context = _context.CreateDbContext();
            var entity = await context.PKKL_OngNhua_2TtChungNSachNgangs.Where(x => x.Id.Equals(id) && x.IsActive != 100).FirstOrDefaultAsync();
            if (entity == null)
            {
        ...
        public async Task Insert(PKKL_OngNhua_2TtChungNSachNgang entity, string userId)
        {
            try
            {
                using var context = _context.CreateDbContext();
                ...
                context.PKKL_OngNhua_2TtChungNSachNgangs.Add(entity);
                var addLog = new PKKL_OngNhua_2TtChungNSachNgang_Log()
                {
                    Id = entity.Id,
                ...
                context.PKKL_OngNhua_2TtChungNSachNgang_Logs.Add(addLog);
        ...
        public async Task Update(PKKL_OngNhua_2TtChungNSachNgang data, string userId)
        {
            using var context = _context.CreateDbContext();
            ...
            context.PKKL_OngNhua_2TtChungNSachNgangs.Update(data);
            if (data.IsActive == 3)
            {
                var updateLog = await (from p in context.PKKL_OngNhua_2TtChungNSachNgang_Logs
                                       where p.IdChung == entity.Id && p.IsValid == true
                                       select p).ToListAsync();
                updateLog.ForEach(p => p.IsValid = false);
                context.PKKL_OngNhua_2TtChungNSachNgang_Logs.UpdateRange(updateLog);
            }
            ...
            else if (entity.IsActive != 3)
            {
                ...
                if (updateLog != null)
                {
                    ...
                    context.PKKL_OngNhua_2TtChungNSachNgang_Logs.Update(updateLog);
                }
            }
            var addLog = new PKKL_OngNhua_2TtChungNSachNgang_Log
            {
        ...
        public async Task UpdateMulti(PKKL_OngNhua_2TtChungNSachNgang[] PKKL_OngNhua_2TtChungNSachNgangs)
        {
            using var context = _context.CreateDbContext();
            string[] ids = PKKL_OngNhua_2TtChungNSachNgangs.Select(x => x.Id).ToArray();
            var listEntities = await context.PKKL_OngNhua_2TtChungNSachNgangs.Where(x => ids.Contains(x.Id)).ToListAsync();
            foreach (var entity in listEntities)
            {
                context.PKKL_OngNhua_2TtChungNSachNgangs.Update(entity);
            }
            await context.SaveChangesAsync();
        }
        public async Task Delete(PKKL_OngNhua_2TtChungNSachNgang data, string userId)
        {
            using var context = _context.CreateDbContext();
            var entity = await GetById(data.Id);
            if (entity == null)
            ...
            else
            {
                ...
                {
                    var logdata = (from p in context.PKKL_OngNhua_2TtChungNSachNgang_Logs
                                   where p.IdChung == entity.Id && p.IsValid == true
                    ...
                    if (logdata != null)
                    {
                        ...
                        context.PKKL_OngNhua_2TtChungNSachNgang_Logs.Update(logdata);
                    }

                    var logupdate = (from p in context.PKKL_OngNhua_2TtChungNSachNgang_Logs
                                     where p.IdChung == entity.Id && p.IsValid == true
                                     select p).ToList();
                    if (logupdate != null)
                    {
                        logupdate.ForEach(p => p.IsValid = false);
                        context.PKKL_OngNhua_2TtChungNSachNgang_Logs.UpdateRange(logupdate);
                    }
                    var addLog = new PKKL_OngNhua_2TtChungNSachNgang_Log()
                    {
                        Id = data.Id,
        ...
        public async Task Approval(PKKL_OngNhua_2TtChungNSachNgang data, string userId)
        {
            using var context = _context.CreateDbContext();
            var entity = await GetById(data.Id);
            if (entity == null)
            ...
            {
                var updateLogs = await context.PKKL_OngNhua_2TtChungNSachNgang_Logs
                    .Where(p => p.IdChung == entity.Id && p.IsValid == true)
                    .ToListAsync();

                updateLogs.ForEach(p => p.IsValid = false);
                context.PKKL_OngNhua_2TtChungNSachNgang_Logs.UpdateRange(updateLogs);
            }
            else if (entity.IsActive != 3)
            {
                var updateLog = await context.PKKL_OngNhua_2TtChungNSachNgang_Logs
        ...
        public async Task NoApproval(PKKL_OngNhua_2TtChungNSachNgang data, string userId)
        {
            using var context = _context.CreateDbContext();
            var entity = await GetById(data.Id);
            ...
            {
                var logdata = context.PKKL_OngNhua_2TtChungNSachNgang_Logs
                    .Where(p => p.IdChung == entity.Id && p.IsValid == true)
                ...
                if (logdata != null)
                {
                    ...
                    if (entity.IsActive == 1)
                    {
                        ...
                        var logupdate = context.PKKL_OngNhua_2TtChungNSachNgang_Logs
        ...
        private void MapFromLogToData(PKKL_OngNhua_2TtChungNSachNgang_Log log, PKKL_OngNhua_2TtChungNSachNgang data)
        {
            foreach (var prop in typeof(PKKL_OngNhua_2TtChungNSachNgang_Log).GetProperties())
            {
                var targetProp = typeof(PKKL_OngNhua_2TtChungNSachNgang).GetProperty(prop.Name);
        ...
        private void MapFromDataToEntity(PKKL_OngNhua_2TtChungNSachNgang data, PKKL_OngNhua_2TtChungNSachNgang entity)
        {
            foreach (var prop in typeof(PKKL_OngNhua_2TtChungNSachNgang).GetProperties())
            {
                if (prop.Name == "Id") continue; // Không ghi đè ID chính
                var entityProp = typeof(PKKL_OngNhua_2TtChungNSachNgang).GetProperty(prop.Name);
        ...
        private void MapFromLogToEntity(PKKL_OngNhua_2TtChungNSachNgang_Log log, PKKL_OngNhua_2TtChungNSachNgang entity)
        {
            foreach (var prop in typeof(PKKL_OngNhua_2TtChungNSachNgang_Log).GetProperties())
            {
        ...
        private PKKL_OngNhua_2TtChungNSachNgang_Log CreateLogFromData(PKKL_OngNhua_2TtChungNSachNgang data, string userId)
        {
            var log = new PKKL_OngNhua_2TtChungNSachNgang_Log();
            foreach (var prop in typeof(PKKL_OngNhua_2TtChungNSachNgang_Log).GetProperties())
            {
                if (prop.Name == "Id")
                {
                ...
                {
                    var dataProp = typeof(PKKL_OngNhua_2TtChungNSachNgang).GetProperty(prop.Name);
                    if (dataProp != null)
                    {
        ...
        public async Task DeleteById(string id, string userId)
        {
            ...
            context.Set<PKKL_OngNhua_2TtChungNSachNgang>().Remove(entity);
            await context.SaveChangesAsync();
        }
        public async Task<bool> CheckStatus(string ids, string name)
        {
            using var context = _context.CreateDbContext();
            var model = await context.PKKL_OngNhua_2TtChungNSachNgangs.Where(p => p.Id == ids && p.IsActive != 100).FirstOrDefaultAsync();
            if (model == null)
            {
                throw new Exception($"Không tìm thấy thông tin đã chọn");
            }
        ...
        public async Task<bool> CheckSave(PKKL_OngNhua_2TtChungNSachNgang input)
        {
            try
            {
                using var context = _context.CreateDbContext();
                var model = await (from p in context.PKKL_OngNhua_2TtChungNSachNgang_Logs
        ...
        public async Task<bool> CheckEdit(PKKL_OngNhua_2TtChungNSachNgang input)
        {
            try
            {
                using var context = _context.CreateDbContext();
        ...
        public async Task<bool> CheckDelete(PKKL_OngNhua_2TtChungNSachNgang input)
        {
            try
            {
                using var context = _context.CreateDbContext();
